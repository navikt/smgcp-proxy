...
class BtsysApiKtTest :
    FunSpec({
        ...
        beforeEach { coEvery { stsOidcClient.oidcToken() } returns OidcToken("token", "type", 1L) }
            ...
            with(TestApplicationEngine()) {
                ...
                test("Happy-case") {
                    with(
                        handleRequest(
                            HttpMethod.Get,
                            "/btsys/api/v1/suspensjon/status?oppslagsdato=$oppslagsdato"
                        ) {
